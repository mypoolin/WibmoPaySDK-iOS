...
### Step 1. 
Add this to your project **podfile** `pod WibmoPaySDK`.Minimum deployment target version for WibmoPaySDK is `9.0` and swift version `4.1` and WibmoPaySDK version is `0.1.3`.
### Step 2. 
